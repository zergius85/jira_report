...
1. [Оптимизация запросов к Jira API](#оптимизация-запросов-к-jira-api)
2. [Архитектурные улучшения](#архитектурные-улучшения)
3. [Улучшения кода core/jira_report.py](#улучшения-кода-corejira_reportpy)
4. [Улучшения кода web/app.py](#улучшения-кода-webapppy)
5. [Улучшения конфигурации](#улучшения-конфигурации)
...
| Приоритет | Задача | Сложность | Время | Экономия запросов |
|-----------|--------|-----------|-------|-------------------|
| 🔴 Высокий | **Предзагрузка changelog (1.1)** | Низкая | 15 мин | **-62%** |
| 🔴 Высокий | **Кэширование project() (1.2)** | Низкая | 10 мин | **-11%** |
| 🔴 Высокий | Выделение классов (2-3) | Средняя | 4 часа | — |
| 🟡 Средний | Batch-запросы (1.3) | Средняя | 1 час | -90% (UI) |
| 🟡 Средний | Устранение дублирования (4) | Низкая | 30 мин | — |
...
|------|-------------|--------|
| 2026-03-06 | Оптимизация запросов к Jira API | ✅ Добавлено |
